...
<div style={{
  ...
  <div style={{ pageBreakInside: "avoid", breakInside: "avoid" }}>
    ...
    />
                ...
                {/* ASSINATURA */}
                <div style={{ marginTop: "3500px", textAlign: "center" }}>
                ...
                {/* RODAPÉ */}
                <div style={{ marginTop: "50px", textAlign: "center", fontSize: "10px", color: "#999", borderTop: "1px solid #e5e7eb", paddingTop: "15px" }}>
